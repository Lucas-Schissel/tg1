...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Seja bem vindo ao CaçaLog</h1>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <h2 class="text-center mt-0">A melhor qualidade está aqui</h2>
                <hr class="divider my-4" />
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-gem text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Atendemos qualquer demanda de entrega</h3>
                            <p class="text-muted mb-0">Do pequeno negócio ao Enterprise!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-laptop-code text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Tudo na sua tela</h3>
                            <p class="text-muted mb-0">Acesso Rápido e Fácil.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-globe text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Sempre Atualizado</h3>
                            <p class="text-muted mb-0">informações sempre em tempo real!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-heart text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Nós se importamos com você</h3>
                            <p class="text-muted mb-0">Alta politica de respeito e transparência com o cliente</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="page-section bg-dark text-white">
            <div class="container text-center">
                <h2 class="mb-4">Esta esperando o que?</h2>
                <a class="btn btn-light btn-xl" href="{{'home'}}">Nada Vamos Nessa!</a>
            </div>
        </section>
        <!-- Contact-->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <hr class="divider my-4" />
                        <p class="text-muted mb-5">Esses são nossos contatos qualquer coisa estamos a sua disposição</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fas fa-phone fa-3x mb-3 text-muted"></i>
                        <div>(49) 3563-0232</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i
                        ><!-- Make sure to change the email address in BOTH the anchor text and the link target below!--><a class="d-block" href="#">cacalog@email.com</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2020 - CaçaLog</div></div>
        </footer>
        <!-- Bootstrap core JS-->
